...
CREATE TABLE passanger_payment_booking (
    passanger_user__id_user BIGINT,
    payment_booking_payment_id BIGINT,
    PRIMARY KEY(passanger_user__id_user, payment_booking_payment_id)
);

-- Constraints and Foreign Keys
ALTER TABLE user_ ADD UNIQUE (username, email);
ALTER TABLE user_ ADD CONSTRAINT Role CHECK (role IN ('Administrator', 'Passenger', 'Crew'));
...
ALTER TABLE crew_ ADD CONSTRAINT crew_fk1 FOREIGN KEY (admin__user__id_user) REFERENCES admin_(user__id_user);
ALTER TABLE crew_ ADD CONSTRAINT crew_fk2 FOREIGN KEY (crew_members_user__id_user) REFERENCES crew_members(user__id_user);
ALTER TABLE passanger_ ADD CONSTRAINT passanger_fk1 FOREIGN KEY (user__id_user) REFERENCES user_(id_user);
ALTER TABLE flight_ ADD CONSTRAINT flight__fk1 FOREIGN KEY (admin__user__id_user) REFERENCES admin_(user__id_user);
ALTER TABLE flight_ ADD CONSTRAINT flight__fk2 FOREIGN KEY (departure_airport_code) REFERENCES airport_(airport_code);
ALTER TABLE flight_ ADD CONSTRAINT flight__fk3 FOREIGN KEY (arrival_airport_code) REFERENCES airport_(airport_code);
ALTER TABLE schedule_ ADD CONSTRAINT schedule__fk1 FOREIGN KEY (admin__user__id_user) REFERENCES admin_(user__id_user);
ALTER TABLE schedule_ ADD CONSTRAINT schedule__fk2 FOREIGN KEY (crew_crew_id) REFERENCES crew_(crew_id);
...
ALTER TABLE ticket_ ADD CONSTRAINT ticket__fk2 FOREIGN KEY (seat_schedule__schedule_id) REFERENCES seat_(schedule__schedule_id);
...
ALTER TABLE seat_ ADD CONSTRAINT seat_fk1 FOREIGN KEY (schedule__schedule_id) REFERENCES schedule_(schedule_id);
ALTER TABLE crew_members ADD CONSTRAINT crew_members_fk1 FOREIGN KEY (user__id_user) REFERENCES user_(id_user);
ALTER TABLE flight_attendante ADD CONSTRAINT flight_attendante_fk1 FOREIGN KEY (crew_crew_id) REFERENCES crew_(crew_id);
...
ALTER TABLE pilot_ ADD CONSTRAINT pilot_fk1 FOREIGN KEY (crew_crew_id) REFERENCES crew_(crew_id);
ALTER TABLE pilot_ ADD CONSTRAINT pilot_fk2 FOREIGN KEY (crew_members_user__id_user) REFERENCES crew_members(user__id_user);
ALTER TABLE passanger_payment_booking ADD CONSTRAINT passanger_payment_booking_fk2 FOREIGN KEY (payment_booking_payment_id) REFERENCES payment_booking(payment_id);
